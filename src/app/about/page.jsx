      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            />
            {/* BIOGRAPHY TITLE */}
            <h1 className="font-bold text-2xl text-[#4B0082]">BIOGRAPHY</h1>
            {/* BIOGRAPHY DESC */}
            <p className="text-lg text-[#4B0082]">
              Versatile software developer adept at crafting innovative
              solutions for real-world challenges. Proficient in full-stack
              development, encompassing interface design, scalable web services,
              database integration and advanced analytics. Expertise spans from
              debugging and testing to seamless deployment, driven by a passion
              for cutting-edge web technologies
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic text-[#4B0082]">
            I specialize in creating scalable solutions for real-world challenges.
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
          ...
          <div className="flex flex-col gap-12 justify-center" ref={skillRef}>
            ...
            <motion.h1
              ...
              className="font-bold text-2xl text-[#4B0082]"
            >
              SKILLS
            </motion.h1>
            {/* SKILL LIST */}
            ...
            >
              <div className="rounded  p-2 text-sm cursor-pointer bg-[#4B0082] text-white hover:bg-white hover:text-black">
                JavaScript
              </div>
              <div className="rounded  p-2 text-sm cursor-pointer bg-[#4B0082] text-white hover:bg-white hover:text-black">
                TypeScript
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    Contributing to the creation and maintenance of SeaBass, a
                    pioneering core banking solution, leveraging React.js.{" "}
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    Led Super Admin interface improvements by conceptualizing,
                    designing and implementing new features, integrating servers
                    for rendering dynamic pages on Credib’s platform.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2023 - 2024{" "}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    Developed REST APIs for seamless internal and external
                    service integration, establishing CI/CD pipelines for
